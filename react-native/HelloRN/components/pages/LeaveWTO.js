...
class LeaveWTO extends React.Component {
  constructor(props){
    super(props);
      ...
      <Container style={styles.container}>
        ...
        <Content style={{width: '100%', marginTop:0}}>
          ...
          <Picker
            ...
            >
            <Item label="Meeting" value="key0" />
            <Item label="Onsite Assignment" value="key1" />
            <Item label="Org. Event" value="key2" />
            <Item label="Training" value="key3" />
            <Item label="Travel" value="key4" />
            <Item label="Work from home" value="key5" />
          </Picker>
